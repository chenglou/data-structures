...
describe "Get all in edges", ->
    ...
    it "should return the in edges", ->
        ...
        4   \5     6 <->
        ###
        expect(graph.getInEdgesOf("1").length).toBe 2
        expect(graph.getInEdgesOf "1").toContain graph.getEdge "2", "1"
        expect(graph.getInEdgesOf "1").toContain graph.getEdge "5", "1"

        expect(graph.getInEdgesOf("2").length).toBe 2
        expect(graph.getInEdgesOf "2").toContain graph.getEdge "3", "2"
        expect(graph.getInEdgesOf "2").toContain graph.getEdge "5", "2"

        expect(graph.getInEdgesOf("3").length).toBe 2
        expect(graph.getInEdgesOf "3").toContain graph.getEdge "2", "3"
        expect(graph.getInEdgesOf "3").toContain graph.getEdge "6", "3"

        expect(graph.getInEdgesOf("4").length).toBe 1
        expect(graph.getInEdgesOf "4").toContain graph.getEdge "1", "4"

        expect(graph.getInEdgesOf "5").toEqual []
        expect(graph.getInEdgesOf("6").length).toBe 1
        expect(graph.getInEdgesOf "6").toContain graph.getEdge "6", "6"
...
describe "Get all out edges", ->
    ...
    it "should return the in edges", ->
        ...
        4   \5     6 <->
        ###
        expect(graph.getOutEdgesOf("1").length).toBe 1
        expect(graph.getOutEdgesOf "1").toContain graph.getEdge "1", "4"

        expect(graph.getOutEdgesOf("2").length).toBe 2
        expect(graph.getOutEdgesOf "2").toContain graph.getEdge "2", "1"
        expect(graph.getOutEdgesOf "2").toContain graph.getEdge "2", "3"

        expect(graph.getOutEdgesOf("3").length).toBe 1
        expect(graph.getOutEdgesOf "3").toContain graph.getEdge "3", "2"

        expect(graph.getOutEdgesOf "4").toEqual []

        expect(graph.getOutEdgesOf("5").length).toBe 2
        expect(graph.getOutEdgesOf "5").toContain graph.getEdge "5", "1"
        expect(graph.getOutEdgesOf "5").toContain graph.getEdge "5", "2"

        expect(graph.getOutEdgesOf("6").length).toBe 2
        expect(graph.getOutEdgesOf "6").toContain graph.getEdge "6", "3"
        expect(graph.getOutEdgesOf "6").toContain graph.getEdge "6", "6"
